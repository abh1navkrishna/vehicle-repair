  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Center(child: Text("The rating given to you",style: TextStyle(color: Colors.grey,fontSize: 20),)),
            Padding(
              padding: const EdgeInsets.only(top: 20),
              child: Container(
                height: 150,
                width: double.infinity,
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(15),color: Color.fromARGB(255, 192, 210, 224)),
